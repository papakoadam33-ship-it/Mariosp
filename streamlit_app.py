...
st.markdown("""
    ...
    /* 2. Sidebar & Dropdown Fix (Το "μπλε" κύκλωμα) */
    [data-testid="stSidebar"] {
        background-color: #121212 !important;
    }
    /* Μαύρα γράμματα ΜΟΝΟ μέσα στα κουτιά επιλογής για να φαίνονται */
    div[data-baseweb="select"] * {
        color: #000000 !important;
    }

    /* 3. Απόκρυψη Toolbar Πίνακα (Το "μωβ" κύκλωμα) */
    [data-testid="stElementToolbar"] {
        display: none !important;
    }

    /* 4. Λευκά γράμματα για την αρχική οθόνη */
    h1, h2, h3, [data-testid="stMarkdownContainer"] p {
        color: #ffffff !important;
    }

    /* 5. Πιο Διαφανή/Λευκά Κουτάκια Προγνωστικών */
    .prediction-box {
        background: rgba(255, 255, 255, 0.15) !important; /* Πιο λευκό/διαφανές */
        padding: 12px;
        border-radius: 10px;
        text-align: center;
...
if st_data and 'standings' in st_data:
    ...
    # Εδώ το "selection_mode" και το CSS κρύβουν το μωβ κύκλωμα
...
for i, m in enumerate(display_m):
    ...
    with st.expander(title):
        # Προσθήκη Over 1.5 και 6 στήλες
        ...
        for idx, (lbl, val) in enumerate(res_list):
            ...
            cols[idx].markdown(f"""
                <div class="prediction-box">
                    <small style="color: #ddd;">{lbl}</small><br>
